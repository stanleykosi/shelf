...
Status: historical refactor guide; U36 in `docs/product/00-decisions.md` supersedes its Home research, standalone assistant and `/markets*` route proposals
Last updated: 2026-09-22
Current refactor phase: architecture complete; implementation not started
Source-of-truth status: historical design record for superseded paths; current numbered specifications in `docs/product/` and U36 govern implementation
