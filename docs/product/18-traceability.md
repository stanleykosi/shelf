...
| U25 live issuer Discover UX, reconciled with required categories and shelf | PR01–PR05, PR16, PR24 | /discover defaults to the reviewed catalog and five categories; /discover?source=issuer provides separate direct-company and AI product-owner paths; canonical product pages save product IDs; brand URLs redirect to live discovery | category browsing and guest/member save work; direct feed search uses no AI; product suggestion links only to matched issuer mint; not-found and unavailable states |
