...
| --- | --- | --- |
| Scan default | [1440](scan-1440-default.png) | [390](scan-390-default.png) · [430](scan-430-default.png) |
| Image preview | [1440](scan-1440-preview-full.png) | [390](scan-390-preview.png) |
| Preview + consent accepted | [1440](scan-1440-preview-consent-accepted-full.png) | [390 preview](scan-390-preview-consent-accepted.png) · [consent and action viewport](scan-390-consent-accepted-actions.png) |
| Consent required | — | [390](scan-390-consent-required.png) |
| Possible match, not confirmed | [1440](results-1440-possible.png) | [390](results-390-possible.png) |
...
```sh
PLAYWRIGHT_BASE_URL=http://127.0.0.1:3300 node --import tsx scripts/capture-scan.ts
```
